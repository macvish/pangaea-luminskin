...
export const REMOVE_ITEM_FROM_ITEM_COUNT = gql`mutation ($id: String!, $products: Array!) {
  removeFromItemCount(id: $id, products: $products) @client
}`

export const CHANGE_CURRENCY = gql`mutation ($currency: Currency!) {
